...
struct Evt {
    ...
    Evt(int n)
        : _n(n)
        , _c0r(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c0r"), n)
        , _c1r(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c1r"), n)
        , _c2r(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c2r"), n)
        , _c3r(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c3r"), n)
        , _c0i(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c0i"), n)
        , _c1i(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c1i"), n)
        , _c2i(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c2i"), n)
        , _c3i(Kokkos::view_alloc(Kokkos::WithoutInitializing, "c3i"), n)
        , e   (Kokkos::view_alloc(Kokkos::WithoutInitializing, "e"),   n)
        , px  (Kokkos::view_alloc(Kokkos::WithoutInitializing, "px"),  n)
        , py  (Kokkos::view_alloc(Kokkos::WithoutInitializing, "py"),  n)
        , pz  (Kokkos::view_alloc(Kokkos::WithoutInitializing, "pz"),  n)
        {}
    ...
    KOKKOS_INLINE_FUNCTION void internal_c0r(const int& c, const double& val)
    {
        _c0r(c) = val;
    }
    KOKKOS_INLINE_FUNCTION void internal_c0i(const int& c, const double& val)
    {
        _c0i(c) = val;
    }
    KOKKOS_INLINE_FUNCTION double internal_c0r(const int& c) const
    {
        return _c0r(c);
    }
    KOKKOS_INLINE_FUNCTION double internal_c0i(const int& c) const
    {
        return _c0i(c);
    }
    KOKKOS_INLINE_FUNCTION simd_double internal_c0r(const int& c, tag_type tag) const
    {
        simd_double c0_simd(&_c0r(c), tag);
        return c0_simd;
    }
    KOKKOS_INLINE_FUNCTION simd_double internal_c0i(const int& c, tag_type tag) const
    {
        simd_double c0_simd(&_c0i(c), tag);
        return c0_simd;
    }
    ...
    {
        c[0].real().copy_to(&_c0r(i), tag);
        c[0].imag().copy_to(&_c0i(i), tag);

        c[1].real().copy_to(&_c1r(i), tag);
        c[1].imag().copy_to(&_c1i(i), tag);

        c[2].real().copy_to(&_c2r(i), tag);
        c[2].imag().copy_to(&_c2i(i), tag);

        c[3].real().copy_to(&_c3r(i), tag);
        c[3].imag().copy_to(&_c3i(i), tag);
    }
